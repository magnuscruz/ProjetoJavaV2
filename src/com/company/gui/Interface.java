...
public class Interface extends JFrame {
    ...
    private void posLogin() {
        ...
        mCliMRestFRestPontSuperPanel = new JPanel();
        ...
        if (sistema.getClienteAtivo() != null) {
            ...
            construirPanelMCliMRestFRestPont();
...
//                    ArrayList<Reserva> listasHisRese;
//                    listasHisRese = sistema.consultarReservasPorCliente();
//                    if (listasHisRese != null) {
//                        String[][] dadosMCliMRestFOrdRestsSSPanel = new String[listasHisRese.size()][2];
//                        int i = 0;
//                        for (Reserva reser : listasHisRese) {
//                            dadosMCliMRestFOrdRestsSSPanel[i][0] = reser.();
//                            dadosMCliMRestFOrdRestsSSPanel[i][1] = pontuacaoMedia3;
//                            i++;
//                        }
//                        mostrarJanela(MCLIMRESTFRESTPONT_CARD);
//                        System.out.println("Entrou!");
//                        String[] nomeColunasMCliMRestFOrdRestsSSPanel = new String[]{"RESTAURANTE", "DATA"};
...
//        }
    ...
    private void construirPanelMCliMRestFOrdRests(JPanel mCliMRestFOrdRestsSuperPanel) {
        ...
        fOrdPontMCliMRestFOrdRestsButton.addActionListener(a -> construirPanelMCliMRestFRestPont());
    ...
    private void construirPanelMCliMRestFRestPont() {
        ...
        if (listasRestPont != null && !listasRestPont.isEmpty()) {
            ...
            for (Restaurante ret : listasRestPont) {
                ...
                dadosMCliMRestFOrdRestsSSPanel[i][1] = "" + sistema.getPontuacaoMediaRestaurante(ret); //converte o double para String
                i++;
            }
            ...
            JScrollPane jScrollMCliMRestFRestCid = new JScrollPane();
            jScrollMCliMRestFRestCid.add(tabelaMCliMRestFOrdRestsSSPanel);
            centroMCliMRestFRestPontSubPanel.add(jScrollMCliMRestFRestCid, BorderLayout.CENTER);
